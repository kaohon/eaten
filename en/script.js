...
const countUp = () => {
    ...
    candyhtml.innerHTML = Number(candy) + " candies";
    allcandyhtml.innerHTML = Number(allcandy) + " candies";
    allcandyhtml_s1.innerHTML = Number(allcandy_s1) + " candies";
    allcandyhtml_s2.innerHTML = Number(allcandy_s2) + " candies";
    ...
    season_rest.innerHTML = rest_d + " days " + rest_h + " hours " + rest_m + " minutes " + rest_s + " seconds";
...
function ecubefunc() {
  if (candy < 50000) {
    ...
    alert("Get the candy stick first!");
  } else {
    ecube_if = true;
...
function wandfunc() {
  if (candy < 60000) {
    ...
    alert("Get the energy cube first!");
  } else if (sword_if === "pretrue") {
    alert("Candy wands and candy swords can only be chosen between!");
...
function dcwandfunc() {
  if (candy < 110000) {
    ...
    alert("Get the Candy Wand first!");
  } else {
    dcwand_if = true;
...
function bwandfunc() {
  if (candy < 180000) {
    ...
    alert("Get the Double Cube Candy Wand first.!");
  } else {
    bwand_if = true;
