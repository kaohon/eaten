...
// 暗号化
        ...
        // 元の変数に復号されたテキストを当てはめる
        const decryptedVariables = decryptedText.split('\n');

        const candy = decryptedVariables[0];
        const count = decryptedVariables[1];
        const countsec = decryptedVariables[2];
        // 他の変数も同様に取得

        // ログに復号された変数を表示
        console.log("Decrypted Candy:", decryptedCandy);
        console.log("Decrypted Count:", decryptedCount);
        console.log("Decrypted Count Sec:", decryptedCountSec);*/